      ...
      <div className="relative bg-gray-50 py-16 sm:py-24 lg:py-32">
        <div className="relative">
          <div className="text-center mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
            <p className="mb-2 text-3xl font-extrabold text-gray-500 tracking-tight sm:text-5xl">
              Helpful
            </p>
          ...
          <div className="mt-12 mx-auto max-w-md px-4 grid gap-8 sm:max-w-lg sm:px-6 lg:px-8 lg:grid-cols-3 lg:max-w-7xl">
            {blogPosts.map((post) => (
              <div
                key={post.id}
                className="flex flex-col rounded-lg shadow-lg overflow-hidden hover:-translate-y-10  hover:scale-105 duration-1000"
              >
                  ...
                  <div className="flex-1">
                    ...
                    <Link to={post.to} className="block mt-2">
                      ...
                      <Link
                        to={post.category.to}
                        type="button"
                        className="inline-flex items-center px-4 py-2 m-6 border border-gray-300 absolute bottom-0 left-0 shadow-sm text-base font-medium rounded-md text-gray-700 bg-white"
                      >
                        Read...
                      </Link>
                    </Link>
